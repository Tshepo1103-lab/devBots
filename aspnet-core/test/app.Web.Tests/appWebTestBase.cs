...
{
    public abstract class appWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static appWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(appWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<appDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<appDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<appDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<appDbContext, Task<T>> func)
        {
            T result;
